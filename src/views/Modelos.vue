<template>
  <div class="modelos">
    ...
    <div class="container">
      ...
      <img class="img" src="\src\views\img\modelo_relacional.jpg" alt="modelo relacional" height="500">
    </div>
    <div class="container">
      <h3>
      ...
      <img class="img" src="\src\views\img\modelo_hierarquico.jpg" alt="modelo hierarquico" height="300">
    </div>
    <div class="container">
      <h3>
        3. Modelo de rede
      ...
      <img class="img" src="\src\views\img\modelo_rede.jpg" alt="modelo rede" height="400">
    </div>
    <div class="container">
      <h3>
        4. Modelo de banco de dados orientado para objetos
      </h3>
      <p>
      ...
      <img class="img" src="\src\views\img\modelo_orientado_objetos.jpg" alt="modelo orientado objetos" height="400">
    </div>
  </div>
</template>
